...
public class Host2 {
    ...
    private ArrayList<String> latestSearch = new ArrayList<String>();
    ...
    public void setCommand(String message)
    {
        ...
        try {
            ...
            if(command.equals("CONNECT"))
            {
                ...
                if (server != null)
                {
                    response.add("A connection with server " + serverName + " has already been established.");
                    closeConnection();
                    return;
                }
            ...
            */
            if(command.equals("GET")){
              ...
              if(latestSearch.isEmpty()){
                response.add("No search results found");
                return;
              }
