...
public class TextDatabase {
     ...
     */
    public synchronized static void insertRowIntoFiles(String username, String path, String server) throws Exception
    {
        if (!checkForExistingUser(username))
        ...
        {
            if (row.equals(username + "," + path + "," + server))
            {
        ...
        if (!duplicateExists)
        {
            ...
            {
                out.println(username + "," + path + "," + server);
            }
        }
    }
